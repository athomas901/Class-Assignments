...
//this function will use my callback (myCallback)

function cube(myCallback, n) {
    return myCallback(n) * n
}
console.log(cube(myCallback, 5))

//function that uses the callback function

function blue(myCallback, n) {
  return myCallback(n) * 7
}
console.log(blue(myCallback, 7))